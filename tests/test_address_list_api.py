...
def test_list(address_factory, api_client):
    """test the get request to view the list of addresses of a state identified by the state name in the url"""
...
def test_search(address_factory, api_client,field):
